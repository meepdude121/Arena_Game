...
public class BubbleGunWeapon : Weapon
{
    ...
    public override void OnShoot(Vector2 targetPosition)
    {
        ...
        targetPosition += new Vector2(Random.Range(-7f, 7f), Random.Range(-7f, 7f));
        ...
        BubbleProjectile bulletComponent = newbullet.GetComponent<BubbleProjectile>();
